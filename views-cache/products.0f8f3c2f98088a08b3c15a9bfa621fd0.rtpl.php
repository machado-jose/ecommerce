<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="product-big-title-area">
    <div class="container scroll-menu-custom">
        <div class="row">
            <div class="col-md-12">
...
<?php require $this->checkTemplate("search-button");?>
                ...
                <div class="single-shop-product">
                    ...
                    <div class="product-option-shop">
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                            <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="/products/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Ver Detalhes</a>
                            </div>
                        </div>
                    </div>                       
                </div>
