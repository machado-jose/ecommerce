...
<div class="product-big-title-area scroll-menu-custom">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                            ...
                                            <input type="submit" value="Atualizar CEP" id="place_order" class="button alt" formaction="/checkout/change-cep" formmethod="post">
										</p>
										<p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
