        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form id="register-form-wrap" action="/register" class="register" method="post">
                    ...
                    <p class="form-row form-row-first">
                        <label for="deslogin">Login <span class="required">*</span>
                        </label>
                        <input type="text" id="deslogin" name="deslogin" class="input-text" value="<?php echo htmlspecialchars( $registerValues["deslogin"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                    </p>
                    <p class="form-row form-row-first">
