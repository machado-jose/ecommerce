<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="product-big-title-area">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="product-bit-title text-center scroll-menu-custom">
                    <h2 id="teste">Carrinho de Compras</h2>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-quantity">
                                            <div class="quantity buttons_added">
                                                ...
                                                <input type="number" size="4" class="qtd" title="Qty" value="<?php echo htmlspecialchars( $value1["nrtotal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
